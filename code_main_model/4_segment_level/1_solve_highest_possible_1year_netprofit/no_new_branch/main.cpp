...
int main()
{
	...
	double* bank_profit = ini_matrix1(nmkt);
	...
	for (int i_mkt = 0; i_mkt < nmkt; ++i_mkt)
		cal_bank_profit(i_mkt, bank_profit, pdf_B_forward[period_sim - 1][i_mkt],  gk_backward[period_sim - 1][i_mkt], adjust_backward[period_sim - 1][i_mkt],
	...
	write1(filename, bank_profit, nmkt);
