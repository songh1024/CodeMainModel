...
const double maxw = 1.5;
const double minr = 0.08;
const double maxr = 0.12;
...
const int maxit_trans_r = 15; // rounds in transition
const int maxit_trans_w = 30;
const int maxit_trans_w_mid = 10;
const double wconv = 1e-3;
const double rconv = 1e-3;

const double update_ratio_w = 0.1;
const double update_ratio_r = 0.3;

const int maxit_bisec_trans_r = 15; // rounds of bisection in solving market clearing w and r
const int maxit_bisec_trans_w = 15;
const int maxit_bisec_trans_w_mid = 15;
const double tol_w_trans = 1e-3;
const double tol_r_trans = 1e-3;

const int nincome_pdf = 100001;
const double min_income = 0.0;
const double max_income = 50.0;

const int nlabor_pdf = 10001;
const double min_labor = 0.0;
const double max_labor = 80.0;
